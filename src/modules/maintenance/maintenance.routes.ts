...
router.get(
  ...
  maintenanceController.getAllByTenant.bind(maintenanceController)
);
...
router.get(
  ...
  maintenanceController.getAllByLandlord.bind(maintenanceController)
);
...
router.patch(
  '/:id/status',
  roleMiddleware(ROLES.LANDLORD),
  validate(updateMaintenanceStatusValidation),
